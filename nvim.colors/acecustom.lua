-- Name:         acecustom
-- Description:  A nvim colorscheme that works with my specific alacritty palette :)
-- Author:       Ken Rodriguez <ken.rodriguez@protonmail.com>
-- Maintainer:   Ken Rodriguez
-- Website:      TBD
-- License:      Same as Vim
-- Last Updated: 2024 May 19
...
hi('Cursor',       {})
hi('lCursor',      {})
hi('DiffText',     { bg = 'Cyan', bold = true,           ctermbg = 'Cyan', cterm = { bold = true } })
...
if vim.o.background == 'light' then
  ...
  hi('Title',        { fg = 'LightGrey', bold = true,              ctermfg = 'DarkMagenta' })
  hi('Visual',       { fg = 'Black', bg = 'LightGrey',             ctermfg = 'Black', ctermbg = 'Grey' })
  hi('WarningMsg',   { fg = 'Yellow',                              ctermfg = 'DarkYellow' })
  hi('Comment',      { fg = 'LightGreen',                          ctermfg = 'LightGreen' })
  hi('Constant',     { fg = 'White',                             ctermfg = 'LightGray' })
  ...
  -- FIXME: this is our default rn
  hi('ColorColumn',  { bg = 'White',                              ctermbg = 'White' })
  hi('CursorColumn', { bg = 'Grey40',                             ctermbg = 'DarkGrey' })
  hi('CursorLine',   { bg = 'Grey40',                             cterm = { underline = true } })
  hi('CursorLineNr', { fg = 'DarkGray', bold = true,              ctermfg = 'DarkGray', cterm = { underline = true } })
  hi('DiffAdd',      { bg = 'Blue',                           	  ctermbg = 'DarkBlue' })
  ...
  -- The important stuff
  hi('Title',        { fg = 'Green', bold = true,                 ctermfg = 'Green' })
  hi('Visual',       { fg = 'LightGrey', bg = '#575757',          ctermfg = 'Black', ctermbg = 'Grey' })
  hi('WarningMsg',   { fg = 'Red',                                ctermfg = 'LightRed' })
  hi('Comment',      { fg = 'LightGreen',                         ctermfg = 'LightGreen' })
  hi('Constant',     { fg = 'White',                              ctermfg = 'White' })
  hi('Special',      { fg = 'LightRed',                           ctermfg = 'LightRed' })
  hi('Identifier',   { fg = 'LightMagenta',                       ctermfg = 'LightMagenta', cterm = { bold = true } })
  hi('Statement',    { fg = 'Cyan', bold = true,          ctermfg = 'Cyan' })	-- type declaration
  hi('PreProc',      { fg = 'LightBlue',                          ctermfg = 'LightBlue' })
  hi('Type',         { fg = 'LightGreen', bold = true,            ctermfg = 'LightGreen' })
  hi('Underlined',   { fg = 'LightBlue', underline = true,        ctermfg = 'LightBlue', cterm = { underline = true } })
